    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Projeto SIGO 2.0}
          {SIGO 2.0 é a modernização do SIGO. Atuei como desenvolvedor Fullstack utilizando \textbf{Dart} com \textbf{Flutter} no app mobile e \textbf{Java} 1.7 com \textbf{Spring Boot} 1.5. Trabalhei nas seguintes funcionalidades: Extrato do Cartão, FAQ, Alertas, Cadastro de Usuário, Edição de Perfil, Pedidos e seção Meus Cartões.}
      \resumeItemListEnd
